              ...
              <?php
               ...
               // Check connection
                ...
                die("Connection failed: " . $conn->connect_error);
                    ...
                    WHERE Name.id_work = Work.id AND Name.id_salary = Salary.id";
                ...
                // output data of each row
                    ...
                    <form action="" method="post">
                      <button type="submit" class="btn btn-danger btn-sm" id='delete' name='delete' value='<?php echo $row['id']; ?>'><i class='fa fa-trash'></i></button>
                      <a href="#edit" data-toggle='modal' value='<?php echo $row['id']; ?>' class='btn btn-success btn-sm' ><i class='fa fa-edit'></i></a>
                    </form>
                    </td>
                    </tr>
                  <?php }
    ...
    <?php
      ...
      if(isset($_POST['update']))
        {	 
            ...
            $sqlx = "UPDATE Name SET Name.id_work='$id_workx', Name.id_salary='$id_salaryx' WHERE Name.id='$idx'";
